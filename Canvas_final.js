 ...
 * @author Andreas Herz
 */
define("draw2d/Canvas",
    [
        "draw2d/geo/Point",
        "draw2d/Selection",
        "draw2d/util/ArrayList",
        "draw2d/command/CommandStack",
        ...
        "draw2d/command/CommandType/DELETE"
    ],
function(
    draw2d_geo_Point,
    draw2d_Selection,
    draw2d_util_ArrayList,
    draw2d_command_CommandStack,
    draw2d_policy_canvas_BoundingboxSelectionPolicy,
    draw2d_policy_canvas_SelectionPolicy,
    draw2d_policy_canvas_SnapToEditPolicy,
    draw2d_policy_EditPolicy,
    draw2d_shape_basic_Line,
    draw2d_Port,
    draw2d_io_Reader,
    draw2d_Figure,
    draw2d_Connection,
    draw2d_command_CommandType,
    draw2d_command_CommandType_DELETE
){
    ...
    return Class.extend({
            ...
            init : function(canvasId, width, height)
            {
                ...
                this.selection  = new draw2d_Selection();
                this.currentDropTarget = null;
                this.isInExternalDragOperation=false;
                this.currentHoverFigure = null;

                this.editPolicy = new draw2d_util_ArrayList();

                // internal document with all figures, ports, ....
                //
                this.figures     = new draw2d_util_ArrayList();
                this.lines       = new draw2d_util_ArrayList(); // crap - why are connections not just figures. Design by accident
                this.commonPorts = new draw2d_util_ArrayList();
                this.dropTargets = new draw2d_util_ArrayList();
                ...
                this.resizeHandles = new draw2d_util_ArrayList();

                // listener for selection handling
                // called if any selection events happens in the canvas
                //
                this.selectionListeners = new draw2d_util_ArrayList();

                // The CommandStack for undo/redo operations
                //
                this.commandStack = new draw2d_command_CommandStack();

                // INTERSECTION/CROSSING handling for connections and lines
                //
                this.linesToRepaintAfterDragDrop =  new draw2d_util_ArrayList();
                this.lineIntersections = new draw2d_util_ArrayList();

                this.installEditPolicy( new draw2d_policy_canvas_BoundingboxSelectionPolicy());
//        this.installEditPolicy( new draw2d.policy.canvas.FadeoutDecorationPolicy());
             ...
             * You can now reload another model to the canvas with a {@link draw2d_io_Reader}
             *
             * @since 1.1.0
             */
            clear : function(){
                ...
                //
                this.figures = new draw2d_util_ArrayList();
                this.lines = new draw2d_util_ArrayList();
                this.commonPorts = new draw2d_util_ArrayList();
                this.dropTargets = new draw2d_util_ArrayList();
             ...
             *
             * @since 2.2.0
             * @param {draw2d_policy_EditPolicy} policy
             */
            installEditPolicy: function(policy){
                // a canvas can handle only one selection policy
                //
                if(policy instanceof draw2d_policy_canvas_SelectionPolicy){
                    ...
                    this.editPolicy.grep($.proxy(function(p){
                        var stay = !(p instanceof draw2d_policy_canvas_SelectionPolicy);
                        if(stay===false){
                            p.onUninstall(this);
                        }
                        return stay;
                ...
                else if (policy instanceof draw2d_policy_canvas_SnapToEditPolicy){
                    // remove existing snapTo policy
                    this.editPolicy.grep($.proxy(function(p){
                        var stay = !(p instanceof draw2d_policy_canvas_SnapToEditPolicy);
                        if(stay===false){
                            p.onUninstall(this);
                        }
                        return stay;
            ...
            uninstallEditPolicy: function(policy){
                if(!(policy instanceof draw2d_policy_EditPolicy)){
                    return; // silently
                }
...
//            paintArea.height(this.initialHeight * this.zoomFactor);
             ...
             *
             * @returns {draw2d_geo_Point} The coordinate in relation to the canvas [0,0] position
             */
            fromDocumentToCanvasCoordinate : function(x, y) {
                return new draw2d_geo_Point(
             ...
             *
             * @returns {draw2d_geo_Point} the coordinate in relation to the document [0,0] position
             */
             ...
             *
             * @param {draw2d_Figure} figure The figure to add.
            ...
            addFigure:function( figure , x,  y)
            {
                ...
                if(figure instanceof draw2d_shape_basic_Line){
             ...
             *
             * @param {draw2d_Figure} figure The figure to remove
             **/
            removeFigure:function(figure){
                ...
                if(figure instanceof draw2d_Connection){
                    figure.disconnect();
                }
            ...
            /**
             * @method
             * Return all intersections draw2d_geo_Point between the given line and all other
             * lines in the canvas.
             *
             * @param {draw2d_shape_basic_Line} line the line for the intersection test
             * @return {draw2d_util_ArrayList}
             */
            getIntersection:function(line){
                var result = new draw2d_util_ArrayList();
             ...
             *
             * @param  {draw2d_Figure} figure The related figure
             * @param  {draw2d_geo_Point} pos The position to adjust
             *
             * @return {draw2d_geo_Point} the adjusted position
             * @private
             **/
             ...
             *
             * @param {draw2d_Port} port The new port which has been added to the Canvas.
             **/
             ...
             *
             * @param {draw2d_Port} p The port to unregister as potential drop target
             * @private
             **/
             ...
             *
             * @return {draw2d_command_CommandStack}
             **/
             ...
             *
             * @param {draw2d_Figure} figure The new selection.
             * @deprecated
             **/
             ...
             * @param {Number} x The x position.
             * @param {Number} y The y position.
             * @param {draw2d_Figure} [figureToIgnore] The figure which should be ignored.
             **/
             ...
             * @param {draw2d_shape_basic_Line} [lineToIgnore] a possible line which should be ignored for the hit test
             *
             * @private
             * @return {draw2d_shape_basic_Line}
             **/
 ...
 *     });
            ...
            onKeyDown:function(keyCode, ctrl)
            {
                ...
                if(keyCode==46 && this.selection.getPrimary()!==null){
                    this.commandStack.execute(this.selection.getPrimary().createCommand(new draw2d_command_CommandType(draw2d_command_CommandType_DELETE)));
                }
                /*
